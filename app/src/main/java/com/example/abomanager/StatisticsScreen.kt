        ...
        bodyContent = {
            MaterialTheme() {
                ...
                Column(
                    ...
                    Text(
                        viewModel.stats.TotalSum.toString(),
                    ...
                    Text(
                        (viewModel.stats.TotalSum * 30).toString(),
                        style = typography.body2
                    )
                    Text(
                        "Cost per Year:",
                    ...
                    Text(
                        (viewModel.stats.TotalSum * 365).toString(),
                        style = typography.body2
                    )
                    Text(
                    ...
                    Text(
                        viewModel.stats.highest.toString(),
                        style = typography.body2
                    )
                    Text(
                    ...
                    Text(
                        viewModel.stats.lowest.toString(),
                        style = typography.body2
                    )
                    Text(
                    ...
                    Text(
                        viewModel.stats.average.toString(),
                        style = typography.body2
                    )
                }
            }
